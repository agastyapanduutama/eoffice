...
class C_user extends CI_Controller
{
    ...
    function getUpk()
    {
        echo json_encode($this->user->data_upk());
    }
    ...
    {
        $id_upk = $_GET['id_upks'];
        echo json_encode($this->user->data_pegawai($id_upk));
    }
    ...
    function data()
    {
        ...
        foreach ($list as $field) {
            ...
            $button = "
                ...
                <button class='btn btn-info btn-sm' id='reset' data-id='$idNa' title='Reset Ulang Kata Sandi'><i class='fas fa-sync-alt'></i></button>
            ";
            $no++;
            $row = array();
