     ...
     <div class="modal-dialog modal-lg" role="document">
         <div class="modal-content">
             <div class="modal-header">
                 <h5 class="modal-title">Buat Surat Keluar Internal</h5>
                 ...
                 <div class="modal-body">
                    <input type="hidden" value="1" name="Internal">
                     ...
                     <div class="form-group">
                         ...
                         <input type="text" placeholder="Mengetahui, Mengizinkan, dll" class="form-control" name="keteranganttd">
                     </div>

                     <div class="form-group">
                         <label>Tanda Tangan Pejabat 2 (opsional)</label>
                         <select class="form-control" name="persetujuan2" id="ttd_pejabat"></select>
                     </div>


                     <div class="form-group">
                         <label>Keterangan Tanda Tangan 2 (opsional)</label>
                         <input type="text" placeholder="Mengetahui, Mengizinkan, dll" class="form-control" name="keteranganttd2">
                     </div>
         ...
         <div class="modal-content">
             ...
             <form id="formRevisiSurat">
                 <div class="modal-body">
                     ...
                     <div class="form-group">
                         <label>Catatan/Isi Surat</label>
                         <textarea name="isi_surat" id="isi_surat1" class="summernote" rows="50"></textarea>
                     </div>
