...
class M_suratkeluar extends CI_Model
{
    ...
    function data_disposisi($id)
    {
        ...
        return $this->db->query("SELECT * FROM t_suratkeluar LEFT JOIN t_jabatan ON t_jabatan.id LIKE '%' + t_suratkeluar.aksi_kirim + '%' WHERE " . $this->req->encKey('t_suratkeluar.id') . " = '" . $id . "'")->row();
    }
