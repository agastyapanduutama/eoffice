...
class M_jabatan extends CI_Model
{
    ...
    function __construct()
    {
        ...
        $this->column_order = array(null, 'kode_jabatan', 'jabatan', 'keterangan');
        $this->column_search = array('kode_jabatan', 'jabatan', 'keterangan');
    ...
    {
        $cek = $this->db->get_where($this->table, array('kode_jabatan' => $data['kode_jabatan'], 'id_upk' => $this->upk))->num_rows();
        if ($cek == 1) {
            return false;
        } else {
